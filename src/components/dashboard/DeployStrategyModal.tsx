      ...
      {isOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-6 bg-[#000000]/80 backdrop-blur-md">
          ...
          >
            ...
            <Card className={cn(
              "bg-[#020617] border-[#2D2D2D] shadow-2xl flex flex-col h-full overflow-hidden relative shrink-0 transition-[width] duration-500 ease-in-out",
              isChatOpen ? "w-[calc(50%-8px)]" : "w-full"
            )}>
              <div className="absolute top-0 right-0 p-8 opacity-5 pointer-events-none">
                <Zap className="w-64 h-64 text-primary" />
              </div>
              <div className="px-6 py-4 border-b border-[#2D2D2D] flex justify-between items-center bg-[#020617]">
                <div>
                ...
                <div className="space-y-6">
                  <div className="grid grid-cols-2 gap-4">
                    <div className="space-y-2">
                      ...
                      <Input 
                        ...
                        className="bg-[#000000] border-[#2D2D2D] focus:ring-primary h-10 font-mono text-sm text-white rounded-lg"
                  ...
                  <div className="space-y-2">
                    ...
                    <Textarea 
                      ...
                      className="bg-[#000000] border-[#2D2D2D] font-mono text-xs text-white min-h-[80px] rounded-lg"
                  ...
                  <div className="flex items-center justify-between p-4 rounded-xl bg-[#000000] border border-[#2D2D2D]">
                      ...
                      >
                        <div className="grid grid-cols-2 gap-4 pt-2">
                          <div className="space-y-2">
                            ...
                            <Input 
                              ...
                              className="bg-[#000000] border-[#2D2D2D] h-9 text-xs font-mono text-white rounded-lg"
                        ...
                        <div className="space-y-2">
                          ...
                          <Textarea 
                            ...
                            className="bg-[#000000] border-[#2D2D2D] font-mono text-xs text-white min-h-[60px] rounded-lg"
                  ...
                  <div className="pt-2 border-t border-[#2D2D2D] mt-4">
                    <Button
                      type="button"
                      variant="outline"
              ...
              <div className="p-4 border-t border-[#2D2D2D] bg-[#020617]">
                <Button 
                  onClick={handleSave}
            ...
            <Card className={cn(
              "bg-[#020617] border-[#2D2D2D] shadow-2xl flex flex-col h-full overflow-hidden relative shrink-0 transition-[width,opacity,border] duration-500 ease-in-out border-l border-slate-800",
              isChatOpen ? "w-[calc(50%-8px)] opacity-100" : "w-0 opacity-0 border-transparent overflow-hidden"
            )}>
              <div className="px-5 py-4 border-b border-[#2D2D2D] flex justify-between items-center bg-[#020617] whitespace-nowrap min-w-[300px]">
                <div className="flex items-center gap-3">
                  <div className="w-6 h-6 rounded bg-[#38BDF8]/10 flex items-center justify-center border border-[#38BDF8]/30">
                    <Sparkles className="w-3.5 h-3.5 text-[#38BDF8]" />
                  </div>
                  <div>
                    <h2 className="text-sm font-black uppercase tracking-widest text-[#38BDF8]">
